...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNCTION_LAYER] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, RGB_MODE_FORWARD, RGB_TOG, QK_BACKLIGHT_TOGGLE_BREATHING, _______, _______, _______,              _______, _______, _______, _______,
